        ...
        <div class="col-12">
            <div class="card p-3">
                <div class="card-header text-dark text-center">
                    <h2 class="text-bold mb-0">Form Tambah Komputer</h2>
                </div>
                <div class="card-body">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <select class="form-select form-select-sm @error('model') is-invalid @enderror" 
                                    ...
                                    <option value="PC" {{ old('model') == 'PC' ? 'selected' : '' }}>PC</option>
                                    <option value="Laptop" {{ old('model') == 'Laptop' ? 'selected' : '' }}>Laptop</option>
                                </select>
                                @error('model')
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <select class="form-select form-select-sm @error('operating_system') is-invalid @enderror" 
                                    ...
                                    <option value="Windows 7" {{ old('operating_system') == 'Windows 7' ? 'selected' : '' }}>Windows 7</option>
                                    <option value="Windows 8" {{ old('operating_system') == 'Windows 8' ? 'selected' : '' }}>Windows 8</option>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control form-control-sm @error('serial.cpu') is-invalid @enderror" 
                                        name="serial[cpu]" value="{{ old('serial.cpu') }}"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control form-control-sm @error('serial.monitor') is-invalid @enderror" 
                                        name="serial[monitor]" value="{{ old('serial.monitor') }}"
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <div class="d-flex align-items-center">
                                    <input type="range" class="form-range me-2" name="kelayakan" min="0" max="100" id="kelayakanRange" value="100" required style="direction: ltr;">
