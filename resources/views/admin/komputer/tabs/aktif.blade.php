            ...
            <tr>
                ...
                <td title="{{ $computer->menuAktif->first()->keterangan ?? '-' }}">
                    ...
                    <div class="btn-group">
                        ...
                        <button type="button" title="Edit" class="btn btn-warning btn-sm d-flex" data-bs-toggle="modal" data-bs-target="#editAktivasiModal{{ $computer->id_barang }}">
          ...
          <div class="tab-content" id="tabContent{{ $computer->id_barang }}">
            ...
            <div class="tab-pane fade show active" id="teknis{{ $computer->id_barang }}" role="tabpanel">
              <form action="{{ route('komputer.update.teknis', $computer->id_barang) }}" method="POST">
                @csrf @method('PUT')
                @include('admin.komputer.partials.edit_teknis_fields', ['komputer' => $computer, 'lokasi' => $lokasi, 'departemen' => $departemen])
                <div class="modal-footer">
                  <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Tutup</button>
            ...
            <div class="tab-pane fade" id="pengguna{{ $computer->id_barang }}" role="tabpanel">
              <form action="{{ route('komputer.update.aktivasi', $computer->id_barang) }}" method="POST">
                @csrf @method('PUT')
                @include('admin.komputer.partials.edit_full_fields', ['komputer' => $computer, 'lokasi' => $lokasi, 'departemen' => $departemen])
                <div class="modal-footer">
                  <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Tutup</button>
