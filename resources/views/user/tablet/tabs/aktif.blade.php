<div class="mb-3 p-0 m-0">
    <div class="row align-items-center">
        ...
        <div class="col-md-4 mb-3">
            <form method="GET" action="{{ route('tablet.index', ['tab' => 'aktif']) }}" class="d-flex" id="filterForm">
            ...
            <a href="{{route('tablet.index', ['tab' => 'aktif'])}}" class="btn btn-danger btn-sm me-1 d-flex justify-content-center align-items-center">
